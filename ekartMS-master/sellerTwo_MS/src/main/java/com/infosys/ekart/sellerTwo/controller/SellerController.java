package com.infosys.ekart.sellerTwo.controller;
...
import com.infosys.ekart.sellerTwo.dto.BaseResponse;
import com.infosys.ekart.sellerTwo.dto.NotificationModel;
import com.infosys.ekart.sellerTwo.dto.ProductDTO;
import com.infosys.ekart.sellerTwo.dto.ProductDetailsDTO;
import com.infosys.ekart.sellerTwo.dto.SellerDTO;
import com.infosys.ekart.sellerTwo.dto.StringResponse;
import com.infosys.ekart.sellerTwo.exception.ProductNameAlreadyPresent;
import com.infosys.ekart.sellerTwo.service.SellerService;
...
public class SellerController {
	...
	public ResponseEntity<StringResponse> modifyProductBySeller(@RequestBody SellerDTO sellerDTO,
		...
		response = restTemplate.postForEntity(productURI+"/product/"+productName+"/modify/sellerTwo", sellerDTO, StringResponse.class);
	...
	public ResponseEntity<String> addProducts(@PathVariable String sellerId, @Valid @RequestBody ProductDTO productDTO,
		...
		return restTemplate.postForEntity(productURI + "/product/add/sellerTwo", productDTO,String.class);
	}
	...
	public List<ProductDetailsDTO> getProducts(@PathVariable String sellerId) {
		...
		// return restTemplate.exchange(OfferURI+"/offer/"+simId,HttpMethod.GET,entity,
		// SimOfferDTO.class).getBody();
		return restTemplate.exchange(productURI + "/products/sellerTwo", HttpMethod.GET, null,
	...
	//Babita  US-37
		...
		public List<ProductDetailsDTO> getProductsInCart(@PathVariable String sellerId) {
			String productURI = "http://ProductMS";
			return restTemplate.exchange(productURI + "/productsincart/sellerTwo", HttpMethod.GET, null,
					new ParameterizedTypeReference<List<ProductDetailsDTO>>() {
					}).getBody();
		}
